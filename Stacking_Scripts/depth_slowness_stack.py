...
sys.path.insert(0, '/Users/r03sb21/Desktop/smurfpytest.0/Processing_Scripts')
sys.path.insert(0, '/Users/r03sb21/Desktop/smurfpytest.0/Migration_Scripts')
sys.path.insert(0, '/Users/r03sb21/Desktop/smurfpytest.0/Stacking_Scripts')
sys.path.insert(0, '/Users/r03sb21/Desktop/smurfpytest.0/Plotting_Scripts')
...
def depth_slowness(Data,conv,lonmin,lonmax,latmin,latmax,noisefilter,rffilter,num_rfs):
    # # Initial options
    # conv = str(sys.argv[1])
    ...
    stack1=pickle.load(open(direc+'Depth_Stacks/'+conversion+'/Depth_Stack_'+noisefilter+filt+'_'+conversion+'_'+str(num_rfs)+'RFs_loc'+str(lat1)+'_'+str(lat2)+'_'+str(lon1)+'_'+str(lon2)+'.PICKLE','rb'))
    ...
    #Labels
    if isreal:
        plt.plot(0.97, d1, marker="s", color='yellow', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
        plt.annotate(str(int(d1)),xy=(0.4, d1), xytext=(0.70, d1), arrowprops=dict(facecolor='black'), fontsize=16, va='center')
    plt.plot(0.97, d2, marker="o", color='gold', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
    plt.plot(0.97, d3, marker="^", color='yellowgreen', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
    plt.annotate(str(int(d2)),xy=(0.4, d2), xytext=(0.70, d2), arrowprops=dict(facecolor='black'), fontsize=16, va='center')
    plt.annotate(str(int(d3)),xy=(0.4, d3), xytext=(0.70, d3), arrowprops=dict(facecolor='black'), fontsize=16, va='center')

    #--------------Slowness Stack
    
    stack2=pickle.load(open(direc+'Slowness_Stacks/Slowness_'+noisefilter+filt+'_'+str(num_rfs)+'RFs'+'.PICKLE','rb'))
    ...
    if isreal:
        ...
        plt.plot(arr1[0][1], arr1[0][2], marker="s", color='yellow', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
        #plt.plot(arr1[1][1], arr1[1][2], marker="s", color='yellow', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
        plt.plot(arr1[2][1], arr1[2][2], marker="s", color='yellow', markersize=12, markeredgecolor='black', markeredgewidth=1.6)

    arr2 = compute_conversions.compute_arrivals_one_depth(d2,conversion=conversion)
    plt.plot(arr2[0][1], arr2[0][2], marker="o", color='gold', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
    #plt.plot(arr2[1][1], arr2[1][2], marker="o", color='gold', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
    plt.plot(arr2[2][1], arr2[2][2], marker="o", color='gold', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
    arr3 = compute_conversions.compute_arrivals_one_depth(d3,conversion=conversion)
    plt.plot(arr3[0][1], arr3[0][2], marker="^", color='yellowgreen', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
    #plt.plot(arr3[1][1], arr3[1][2], marker="^", color='yellowgreen', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
    plt.plot(arr3[2][1], arr3[2][2], marker="^", color='yellowgreen', markersize=12, markeredgecolor='black', markeredgewidth=1.6)
    ...
    #Save figures
    plt.savefig(savepath+'/Dep_Slow_Stack_'+str(num_rfs)+'_'+noisefilter+filt+'.pdf')
    plt.savefig(savepath+'/Dep_Slow_Stack_'+str(num_rfs)+'_'+noisefilter+filt+'.png')
