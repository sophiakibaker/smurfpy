...
def plot_data_selection(Data, noise, Filt):
    # Command line help
    ...
    for stadir in stadirs:
        ...
        station_file = open(stadir + '/selected_RFs_'+str(noise)+str(filt)+'.dat','r')
    ...
    plt.xlabel('mags')
    plt.ylabel('dist')
    plt.title('the distribution of "Acceptable - Green" and "Removed - red" events')
